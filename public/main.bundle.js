...
/***/ function(module, exports, __webpack_require__) {
	...
	var Angular2TokenUiModule = (function () {
	    function Angular2TokenUiModule() {
	    }
	    Angular2TokenUiModule = __decorate([
	        core_1.NgModule({
	            imports: [
	    ...
	    ], Angular2TokenUiModule);
	    return Angular2TokenUiModule;
	}());
	exports.Angular2TokenUiModule = Angular2TokenUiModule;
	//# sourceMappingURL=angular2-token-ui.module.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	     true ? factory(exports, __webpack_require__(4), __webpack_require__(376), __webpack_require__(45), __webpack_require__(11), __webpack_require__(140)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(4);
	var Angular2TokenUiComponent = (function () {
	    function Angular2TokenUiComponent() {
	    }
	    Angular2TokenUiComponent = __decorate([
	        core_1.Component({
	            selector: 'angular2-token-ui',
	            templateUrl: 'angular2-token-ui.component.html'
	        }), 
	        __metadata('design:paramtypes', [])
	    ], Angular2TokenUiComponent);
	    return Angular2TokenUiComponent;
	}());
	exports.Angular2TokenUiComponent = Angular2TokenUiComponent;
	//# sourceMappingURL=angular2-token-ui.component.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Angular2TokenService = (function () {
	    function Angular2TokenService(_http, _activatedRoute) {
	        this._http = _http;
	    ...
	    Angular2TokenService.prototype.get = function (path, requestOptions) {
	        return this.sendHttpRequest({
	            requestMethod: http_1.RequestMethod.Get,
	            path: path,
	            requestOptions: requestOptions
	        });
	    };
	    Angular2TokenService.prototype.post = function (path, data, requestOptions) {
	        return this.sendHttpRequest({
	    ...
	    Angular2TokenService.prototype.put = function (path, data, requestOptions) {
	        return this.sendHttpRequest({
	    ...
	    Angular2TokenService.prototype.delete = function (path, requestOptions) {
	        return this.sendHttpRequest({
	            requestMethod: http_1.RequestMethod.Delete,
	            path: path,
	            requestOptions: requestOptions
	        });
	    };
	    Angular2TokenService.prototype.patch = function (path, data, requestOptions) {
	        return this.sendHttpRequest({
	            requestMethod: http_1.RequestMethod.Patch,
	            path: path,
	            body: data,
	            requestOptions: requestOptions
	        });
	    };
	    Angular2TokenService.prototype.head = function (path, requestOptions) {
	        return this.sendHttpRequest({
	            requestMethod: http_1.RequestMethod.Head,
	            path: path,
	            requestOptions: requestOptions
	        });
	    };
	    Angular2TokenService.prototype.options = function (path, requestOptions) {
	        return this.sendHttpRequest({
	            requestMethod: http_1.RequestMethod.Options,
	            path: path,
	            requestOptions: requestOptions
	        });
	    };
	    // Construct and send Http request
	    Angular2TokenService.prototype.sendHttpRequest = function (options) {
	        var headers;
	        var baseRequestOptions;
	        var mergedRequestOptions;
	        // Set Headers
	        ...
	        var response = this._http.request(new http_1.Request(mergedRequestOptions)).share();
	    ...
	    Angular2TokenService.prototype._getAuthDataFromParams = function () {
	        if (this._activatedRoute.params != null) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var MulticastObservable_1 = __webpack_require__(362);
	var ConnectableObservable_1 = __webpack_require__(136);
	/**
